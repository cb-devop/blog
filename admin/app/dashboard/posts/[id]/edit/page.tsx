    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          featuredImage: post.featuredImg || post.featuredImage || "",
          category: post.categories?.[0]?.id || "",
          tags: post.tags?.map((t: any) => t.name) || [],
          status: post.status || "DRAFT",
          seo: {
            metaTitle: post.seoTitle || "",
            metaDescription: post.seoDesc || "",
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Category</label>                <select
